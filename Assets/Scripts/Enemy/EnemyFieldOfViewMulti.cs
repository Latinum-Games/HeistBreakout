...
public class EnemyFieldOfViewMulti : MonoBehaviour {
    ...
    private AIChasingMulti scriptChasing;
    ...
    void Start()
    {
        ...
        scriptChasing = GetComponent<AIChasingMulti>();
...
#if UNITY_EDITOR
[CustomEditor(typeof(EnemyFieldOfViewMulti))]
public class HandlesDemoEditorMulti : Editor 
{
    public void OnSceneGUI() 
    {
        var linkedObject = target as EnemyFieldOfViewMulti;
